...
export const showQuotesForm = () =>
  ...
  <form id="quote-form" class="quoteForm" novalidate>
    <div class="quote-input">
      <label id="label-quote" for="quote">Tu comentario nos importa</label> <br>
      <input id="input-quote" required placeholder="Comenta algo" class="input primary" type="text">        <button type="submit" class="button primary">Añadir</button>
      </div>
  </form> 
  `;
